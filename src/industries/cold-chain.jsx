  ...
  return (
    <>
      <style>{`
        ...
        .coldchain-hero {
          position: relative;
          background: url('/coldchainhero.jpg') center/cover no-repeat;
          color: white;
        ...
        @media (max-width: 768px) {
          .coldchain-hero h1 { font-size: 2.2rem; }
          .coldchain-hero .tagline { font-size: 1.2rem; }
          .section-title { font-size: 2rem; }
          .container { padding: 0 20px; }
        }
        @media (max-width: 480px) {
          .coldchain-hero h1 { font-size: 1.8rem; }
