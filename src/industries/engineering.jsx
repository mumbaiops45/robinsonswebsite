    ...
    <>
      <style>{`
        ...
        .engineering-hero {
          position: relative;
          background:  
                      url('/engineeringhero.jpg') center/cover no-repeat;
          color: white;
        ...
        @media (max-width: 768px) {
          .engineering-hero h1 { font-size: 2.2rem; }
          .engineering-hero .tagline { font-size: 1.2rem; }
          .section-title { font-size: 2rem; }
          .container { padding: 0 20px; }
          .overview-grid { grid-template-columns: 1fr; gap: 2rem; }
        }
        @media (max-width: 480px) {
          .engineering-hero h1 { font-size: 1.8rem; }
