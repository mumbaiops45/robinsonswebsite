...
//               <div className="tl-yr">1954</div>
//               <div className="tl-txt">Robinsons Bombay Pvt Ltd commenced stevedoring operations in Mumbai</div>
//             </div>
//             <div className="tl-row">
//               <div className="tl-yr">1972</div>
//               <div className="tl-txt">Entered freight forwarding as Robinsons Air Services — establishing the air cargo foundation</div>
//             </div>
//             <div className="tl-row">
//               <div className="tl-yr">1970–2000</div>
//               <div className="tl-txt">Expanded to Delhi, Bengaluru, Hyderabad, Kolkata, Chennai; obtained IATA & FIATA accreditation</div>
//             </div>
//             <div className="tl-row">
//               <div className="tl-yr">2000–2010</div>
//               <div className="tl-txt">ISO 9001 certified; restructured into Pvt Ltd; launched cold chain in Bhiwandi & New Delhi</div>
//             </div>
//             <div className="tl-row">
//               <div className="tl-yr">2017</div>
//               <div className="tl-txt">Awarded GDP & AEO-LO Certification — among the first in India</div>
//             </div>
//             <div className="tl-row">
//               <div className="tl-yr">2021–22</div>
//               <div className="tl-txt">Joined Indian Space Association; became WCA Interglobal member (ID: 98952)</div>
//             </div>
//             <div className="tl-row">
//               <div className="tl-yr">2024</div>
//               <div className="tl-txt">Achieved ISO 14001 Environmental Management System Certification</div>
//             </div>
//           </div>
//         </div>
...
//                 <span className="cnt" data-to="150">
//                   0
//                 </span>
//                 <em>+</em>
//               </div>
//               <div className="af-lbl">Professionals</div>
//               <div className="af-line"></div>
//             </div>
//             <div className="af">
//               <div className="af-val">
//                 <span className="cnt" data-to="15">
//                   0
//                 </span>
//               </div>
//               <div className="af-lbl">Offices in India</div>
//               <div className="af-line"></div>
//             </div>
//             <div className="af">
//               <div className="af-val">
//                 <span className="cnt" data-to="120">
//                   0
//                 </span>
//                 <em>+</em>
//               </div>
//               <div className="af-lbl">Global Partners</div>
//               <div className="af-line"></div>
//             </div>
//             <div className="af">
//               <div className="af-val">
//                 <span className="cnt" data-to="70">
//                   0
//                 </span>
//                 <em>+</em>
//               </div>
//               <div className="af-lbl">Years of Excellence</div>
//               <div className="af-line"></div>
//             </div>
//           </div>
...
//                 <span className="pb-lbl">Air Freight Expertise</span>
//                 <span className="pb-val">92%</span>
//               </div>
//               <div className="pb-track">
//                 <div className="pb-fill" data-w="92"></div>
//               </div>
//             </div>
//             <div className="pb-row">
//               <div className="pb-head">
//                 <span className="pb-lbl">Ocean Freight</span>
//                 <span className="pb-val">88%</span>
//               </div>
//               <div className="pb-track">
//                 <div className="pb-fill" data-w="88"></div>
//               </div>
//             </div>
//             <div className="pb-row">
//               <div className="pb-head">
//                 <span className="pb-lbl">Customs Clearance</span>
//                 <span className="pb-val">95%</span>
//               </div>
//               <div className="pb-track">
//                 <div className="pb-fill" data-w="95"></div>
//               </div>
//             </div>
//             <div className="pb-row">
//               <div className="pb-head">
//                 <span className="pb-lbl">Project Logistics</span>
