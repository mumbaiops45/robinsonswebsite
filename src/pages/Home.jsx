...
// // //         <div className="hero-badge animate-badge">
// // //           <span className="badge-dot" />
// // //           Since 1954 · Trusted Across Continents
// // //         </div>
...
// // //             <span className="hero-heading-accent">Every Mile</span>
// // //           </span>
// // //         </h1>

// // //         <p className="hero-sub animate-sub">
// // //           A legacy of logistics excellence spanning generations. We move your 
// // //           business forward with precision, reliability, and a global network 
// // //           built on trust.
// // //         </p>
...
// //   const stats = [
// //     { number: 150, suffix: '+', label: 'Professionals', target: 150 },
// //     { number: 15, suffix: '', label: 'Offices', target: 15 },
// //     { number: 120, suffix: '+', label: 'Partners', target: 120 },
// //     { number: 70, suffix: '+', label: 'Years', target: 70 }
// //   ];
...
// //           setCountedStats(prev => {
// //             const newStats = [...prev];
// //             newStats[idx] = Math.floor(increment * currentStep);
// //             return newStats;
// //           });
// //         }
// //       }, intervalTime);
...
// //         <div className="hero-badge animate-badge">
// //           <span className="badge-dot" />
// //           <span className="badge-text">Since 1954 · Trusted Across Continents</span>
...
// //                   <span className="stat-counter">{countedStats[index]}</span>
// //                   {stat.suffix}
// //                 </div>
...
// //                     style={{ width: `${(countedStats[index] / stat.target) * 100}%` }}
// //                   />
// //                 </div>
// //               </div>
...
// const Hero = () => {
//   const [imageLoaded, setImageLoaded] = useState(false);
//   // Remove unused state - comment out or delete this line
//   // const [currentStatIndex, setCurrentStatIndex] = useState(0);
...
//     // Create an array to store interval IDs for cleanup
//     const intervals = [];
...
const Hero = () => {
  ...
  // Wrap stats in useMemo to prevent recreation on every render
  const stats = useMemo(() => [
    { number: 150, suffix: '+', label: 'Professionals', target: 150 },
    { number: 15, suffix: '', label: 'Offices', target: 15 },
    { number: 120, suffix: '+', label: 'Partners', target: 120 },
  ...
  }, [stats]); // stats is now stable and won't change
